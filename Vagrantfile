...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.hostname = 'chef-squirrelmail-berkshelf'
  ...
  config.vm.box = 'debian-7.0.1'
#config.vm.box_url = "http://bit.ly/1weDdiJ"
config.vm.box_url = "http://localhost/box/debian-7-dev-virtualbox-chef.box"
  config.vm.hostname = "webmail.a1a2.srv.gov.pf"
