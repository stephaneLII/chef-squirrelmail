...
default['chef-squirrelmail']['data_dir'] = '/var/lib/squirrelmail/data/
default['chef-squirrelmail']['attachment_dir'] = '/var/spool/squirrelmail/attach/'
...
default['chef-squirrelmail']['host'] = ''
default['chef-squirrelmail']['base'] = ''
default['chef-squirrelmail']['name'] = ''
default['chef-squirrelmail']['port'] = ''
default['chef-squirrelmail']['binddn'] = ''
default['chef-squirrelmail']['bindpw'] = 'password'
default['chef-squirrelmail']['protocol'] = 3
default['chef-squirrelmail']['abook_global_file'] = ''
